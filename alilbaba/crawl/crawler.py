...
class AlibabaCrawler:
    BASE_URL = 'https://www.alibaba.ir/train/THR-QUM?adult=1&child=0&infant=0&ticketType=Family&isExclusive=false&&departing='

    def __init__(self, username='mamf', date_str: str = datetime.datetime.now().strftime('%Y-%m-%d')):
    ...
    def scrapy_tickets_page(self) -> tuple[HtmlResponse, WebDriver]:
        ...
        url = self.BASE_URL + self.date_str
